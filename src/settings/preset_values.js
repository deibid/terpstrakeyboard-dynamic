    ...
    settings: [
      ...
      },
      {
        value: {
          ...
          "spectrum_colors": false,
          "scale": scale_12_ed2_parsed,
          "description": "12-tone equal tempered scale consisting of 12 sonically equal divisions per frequency halving/doubling, mapped on harmonic table variant layout.",
          "short_description": "12-ed2 Harmonic Variation",
          "names": scale_12_ed2_names,
          "note_colors": ["#ffffff", "#bababa", "#8ef4fb", "#bababa", "#ffffff", "#ffffff", "#bababa", "#ffffff", "#49aded", "#ffffff", "#bababa", "#ffffff"],
        },
        name: "Harmonic variation"
      },
      {
        value: {
          "output": "sample",
      ...
      },
      {
        value: {
          ...
          "spectrum_colors": false,
          "scale": scale_12_ed2_parsed,
          "description": "12-tone equal tempered scale consisting of 12 sonically equal divisions per frequency halving/doubling, mapped on Park layout.",
...
! Fokblock([64/63, 968/945, 36/35, 704/675], [5, 13, 6, 6]) wakalix`,
      ...
      },
      {
        ...
        value: {
          ...
          "equivSteps": 53,
          "spectrum_colors": false,
          "scale": parseScale(scale_53_ri_3l_male_western).scale,
...

      {
        ...
        value: {
          ...
          "equivSteps": 53,
          "spectrum_colors": false,
          "scale": parseScale(scale_53_ri_3l_female_eastern).scale,
    ...
    settings: [
...

      {
        value: {
          ...
          "spectrum_colors": true,
          "fundamental_color": "#55FF55",
          "scale": parseScale(scale_wmri_in7_har6).scale,
