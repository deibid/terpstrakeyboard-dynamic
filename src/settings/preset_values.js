    ...
    settings: [
      {
        value: {
          ...
          "equivSteps": 7,
          "spectrum_colors": false,
          "scale": parseScale(scale_7_ji_rast_maqam),
...

      {
        value: {
          ...
          "equivSteps": 12,
          "spectrum_colors": false,
          "scale": parseScale(scale_12_ji_7l),
...

      {
        value: {
          ...
          "equivSteps": 17,
          "spectrum_colors": false,
          "scale": parseScale(scale_17_ji_5l),
...

      {
        value: {
          ...
          "spectrum_colors": false,
          "key_labels": "names",
          "scale": parseScale(scale_17_ji_11l_wilson),
...
! Fokblock([64/63, 968/945, 36/35, 704/675], [5, 13, 6, 6]) wakalix`,
...

      {
        value: {
          ...
          "spectrum_colors": false,
          "key_labels": "names",
          "scale": parseScale(scale_22_ji_5l),
...

      {
        value: {
          ...
          "spectrum_colors": false,
          "key_labels": "names",
          "scale": parseScale(scale_31_ji_7l_fokker),
...

      {
        ...
        "value": {
          ...
          "key_labels": "names",
          "scale": parseScale(scale_43_ji_11l_partch),
      ...
      },
      {
        ...
        value: {
          ...
          "equivSteps": 53,
          "spectrum_colors": false,
          "scale": parseScale(scale_53_ri_3l_male_western),
...

      {
        ...
        value: {
          ...
          "equivSteps": 53,
          "spectrum_colors": false,
          "scale": parseScale(scale_53_ri_3l_female_eastern),
    ...
    settings: [
      {
        value: {
          ...
          "spectrum_colors": true,
          "fundamental_color": "#55FF55",
          "scale": parseScale(scale_12_stretched_inharmonic6_harmonic7),
...

      {
        value: {
          ...
          "spectrum_colors": true,
          "fundamental_color": "#55FF55",
          "scale": parseScale(scale_wmri_in7_har6),
